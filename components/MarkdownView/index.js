...
const CodeBlock = (theme) => ({
  h1: (props) => <h1 className="text-pink dark:text-pink-d my-2 text-3xl font-bold" {...props} />,
  h2: (props) => <h2 className="text-green dark:text-green-d my-2 text-2xl font-bold" {...props} />,
  ...
  a: (props) => <a className="p-1 text-purple dark:text-purple-d hover:border-b-2	hover:border-b-purple dark:hover:border-b-purple-d" {...props} />,
